...
class ProfileBody extends StatelessWidget {
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                item(context, Icons.person, "Personal Information", onPress:(){} ),
                item(context, Icons.payment, "Payment Method", onPress:(){}),
                item(context, Icons.shopping_cart, "Order History", onPress:(){}),
                item(context, Icons.pin_drop, "Address", onPress:(){}),
                item(context, Icons.support_agent, "Support Center", onPress:(){}),
                SizedBox(height: 20),
                TextButton(
  ...
  Widget item(BuildContext context, IconData icon, String information,{required VoidCallback onPress}) {
    return Container(
      height: 60,
